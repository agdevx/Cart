...
public class TripRepository(CartDbContext context) : ITripRepository
{
    ...
    public async Task<bool> IsUserCollaboratorAsync(Guid tripId, Guid userId)
    {
    ...
    public async Task AddCollaboratorAsync(Guid tripId, Guid userId)
    {
    ...
    public async Task RemoveCollaboratorAsync(Guid tripId, Guid userId)
    {
